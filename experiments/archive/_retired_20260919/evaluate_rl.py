...
Example:
    python experiments/evaluate_rl.py \
        --algorithm ppo \
        --model_path train_data/amsterdam_reference/AgriControl/ppo/deterministic/models/cosmic-music-45/best_model.zip \
        --vecnorm_path train_data/amsterdam_reference/AgriControl/ppo/deterministic/envs/cosmic-music-45/best_vecnormalize.pkl \
...
def main():
    ...
    parser.add_argument("--save_dir", default="results/amsterdam_reference/rl/")
