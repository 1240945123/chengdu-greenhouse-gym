...
# Load the data
states_pipe = pd.read_csv("data/AgriControl/comparison/glassgym/states_no_growPipe2009.csv")
led_data = pd.read_csv("data/AgriControl/comparison/matlab/states_no_growPipe2009.csv")
# weather_pipe = pd.read_csv("data/AgriControl/comparison/glassgym/weather_pipe2009.csv").iloc[:states_pipe.shape[0]]
...
# Load control data
controls_pipe = pd.read_csv("data/AgriControl/comparison/glassgym/controls_pipe2009.csv").iloc[:states_pipe.shape[0]]
